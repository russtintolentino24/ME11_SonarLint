...
import com.example.webservice.models.AlbumsRequest;
...
public class AlbumController {
    ...
    public @ResponseBody
    String addAlbum(@RequestBody AlbumsRequest albums) {
    ...
    public @ResponseBody
    String updateAlbum(@RequestBody AlbumsRequest albums) {
        Albums albumToInsert = new Albums();
    ...
    public @ResponseBody
    String deleteAlbum(@RequestBody AlbumsRequest albums) {
